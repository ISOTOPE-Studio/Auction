...
public class S {
	...
	public static String toPrefixRed(String s) {
		return new StringBuilder(Auction.prefix).append(ChatColor.RED).append(s).toString();
	}

	public static String toPrefixGreen(String s) {
		return new StringBuilder(Auction.prefix).append(ChatColor.GREEN).append(s).toString();
	}
